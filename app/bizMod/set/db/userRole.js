...
// 添加用户
export const addUserRole = async ({ name, phone, password, email, type }) => {
...
export const queryUserRole = async (data) => {
...
// 查询用户权限
export const queryUserUserRolePermission = async (id) => {
  const sql = `
    SELECT
      DISTINCT
...
// 编辑用户
export const editUserRole = async (parameter) => {
